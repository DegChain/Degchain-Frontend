  ...
  return (
    ...
    shadow-white'>
      ...
      flex-col justify-evenly	 items-center	 gap-2 rounded-xl">
          ...
          <Link className="w-2/3 h-1/5 " href="/admin/new"><button className="w-full h-full text-xl font-medium text-center align-middle bg-gray-300">Make New Record</button></Link>
        </div>
      </div>
    </div>
  )
